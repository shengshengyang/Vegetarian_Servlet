 ...
 var app = window.AddressSeleclList =
    {
        AdrressArray: [
            ...
            ['新北市', '207萬里區', '208金山區', '220板橋區', '221汐止區', '222深坑區', '223石碇區', '224瑞芳區', '226平溪區', '227雙溪區', '228貢寮區', '231新店區', '232坪林區', '233烏來區', '234永和區', '235中和區', '236土城區', '237三峽區', '238樹林區', '239鶯歌區', '241三重區', '242新莊區', '243泰山區', '244林口區', '247蘆洲區', '248五股區', '249八里區', '251淡水區', '252三芝區', '253石門區'],
            ...
            ['彰化縣', '500彰化市', '502芬園鄉', '503花壇鄉', '504秀水鄉', '505鹿港鎮', '506福興鄉', '507線西鄉', '508和美鎮', '509伸港鄉', '510員林市', '511社頭鄉', '512永靖鄉', '513埔心鄉', '514溪湖鎮', '515大村鄉', '516埔鹽鄉', '520田中鎮', '521北斗鎮', '522田尾鄉', '523埤頭鄉', '524溪州鄉', '525竹塘鄉', '526二林鎮', '527大城鄉', '528芳苑鄉', '530二水鄉'],
    ...
    function show() {
        //取出指定縣市及鄉鎮市區的下拉選單的值
        alert(AddressSeleclList.ReturnSelectAddress('city', 'area'));
    }